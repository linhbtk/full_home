...
//        $this->menu = array(
//            array('label' => Yii::t('adm/actions', 'return'), 'url' => $url_redirect),
//        );
    } else {
        $this->breadcrumbs = array(
...
//        $this->menu = array(
//            array('label' => Yii::t('adm/book', 'List ' . $modelName), 'url' => array('/' . lcfirst($modelName) . '/admin')),
//        );
    }
                    ...
                    <div>
                        ...
                        <?php else: ?>
                            <div class="form-group">
                                <?php
                                    echo CHtml::link('<i class="fa fa-download"></i> ' . 'Download định dạng file Excel mẫu', array('/importExcel/excelTemplate', 'm' => $modelName), array('class' => 'btn btn-warning'));
                                ?>
                            </div>
