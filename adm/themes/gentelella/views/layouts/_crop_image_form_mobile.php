<!-- Cropping modal -->
<div class="modal fade" id="avatar-modal-mobile" aria-hidden="true" aria-labelledby="avatar-modal-label" role="dialog"
     tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form class="avatar-form" action="<?php echo Yii::app()->createUrl('aImageProgress/CropImage', array('dir_upload'=>(isset($dir_upload))?$dir_upload:''));?>" enctype="multipart/form-data" method="post">
