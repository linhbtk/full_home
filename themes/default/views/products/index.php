...
<div class="container">
    ...
    <div class="product_list">
        ...
        <div class="title_cate">
            <span class="name_cate">Hộp thủy tinh Kloken</span>
            <span class="more_cate hidden-xs"><?= Yii::t('web/full_home', 'other_products'); ?> Kloken</span>
        </div>
        <div class="line_1"></div>
        <div class="space_30 hidden-xs"></div>
        <div class="list">
            <div class="col-md-3 col-xs-6">
                <a href="<?= Yii::app()->controller->createUrl('products/detail'); ?>" title="">
                    <div class="thumbnail">
    ...
    <div class="product_list">
        <div class="space_30"></div>
        <div class="title_cate">
            <span class="name_cate">Hộp thủy tinh Komax</span>
            <span class="more_cate hidden-xs"><?= Yii::t('web/full_home', 'other_products'); ?> Komax</span>
        </div>
        <div class="line_1"></div>
        <div class="space_30 hidden-xs"></div>
        <div class="list">
