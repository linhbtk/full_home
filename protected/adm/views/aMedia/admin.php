<?php
    ...
    $this->menu        = array(
        array('label' => Yii::t('adm/app', 'Import') . ' ' . $this->modelDisplayAttribute, 'url' => array('/aImportExcel/index', 'm' => 'AMedia'), 'linkOptions' => array('class' => 'btn_create')),
            ...
            array(
                ...
                'tabs'        => array(
                    array(
                        ...
                        'content' => $this->renderPartial('_tab_admin_by_status', array('model' => $model, 'type' => AMedia::ACTIVE), TRUE),
                        'active'  => TRUE,
                    ),
                    array(
                        'label'   => Yii::t('adm/media', 'status_' . AMedia::INACTIVE),
                        'content' => $this->renderPartial('_tab_admin_by_status', array('model' => $model, 'type' => AMedia::INACTIVE), TRUE),
                    ),
                    array(
                        'label'   => Yii::t('adm/media', 'status_' . AMedia::PENDING),
                        'content' => $this->renderPartial('_tab_admin_by_status', array('model' => $model, 'type' => AMedia::PENDING), TRUE),
                    ),
                ),
