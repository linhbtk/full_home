...
<table cellspacing="0" cellpadding="10" style="color:#666;font:13px Arial;line-height:1.4em;width:100%;">
    ...
    <tr>
        <td>
            <?php if (isset($data['message'])) echo CHtml::encode($data['message']); ?>
        </td>
    </tr>
    <tr>
        <td>
            <?php if (isset($data['name'])) echo CHtml::encode($data['name']); ?>
        </td>
    </tr>
    <tr>
        <td>
            <?php if (isset($data['company'])) echo CHtml::encode($data['company']); ?>
        </td>
    </tr>
    </tbody>
</table>
