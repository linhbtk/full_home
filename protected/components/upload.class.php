...
//
     ...
     *  <li><b>dir_auto_chmod</b> automatically attempts to chmod the destination directory if not writeable (default:
     *  true)<br>
     ...
     *  <li><b>allowed</b> array of allowed mime-types. wildcard accepted, as in image/* (default: check {@link
     *  Init})<br>
     *  <pre>$handle->allowed = array('application/pdf','application/msword', 'image/*');</pre></li>
     *  <li><b>forbidden</b> array of forbidden mime-types. wildcard accepted, as in image/*  (default: check {@link
     *  Init})<br>
     *  <pre>$handle->forbidden = array('application/*');</pre></li>
     * </ul>
     * <ul>
     *  <li><b>image_convert</b> if set, image will be converted (possible values : ''|'png'|'jpeg'|'gif'|'bmp';
     *  default: '')<br>
     *  <pre>$handle->image_convert = 'jpg';</pre></li>
     *  <li><b>image_background_color</b> if set, will forcibly fill transparent areas with the color, in hexadecimal
     *  (default: null)<br>
     *  <pre>$handle->image_background_color = '#FF00FF';</pre></li>
     *  <li><b>image_default_color</b> fallback color background color for non alpha-transparent output formats, such
     *  as JPEG or BMP, in hexadecimal (default: #FFFFFF)<br>
     ...
     *  <li><b>jpeg_size</b> if set to a size in bytes, will approximate {@link jpeg_quality} so the output image fits
     *  within the size (default: null)<br>
     ...
     * <ul>
     *  <li><b>image_max_width</b> if set to a dimension in pixels, the upload will be invalid if the image width is
     *  greater (default: null)<br>
     *  <pre>$handle->image_max_width = 200;</pre></li>
     *  <li><b>image_max_height</b> if set to a dimension in pixels, the upload will be invalid if the image height is
     *  greater (default: null)<br>
     *  <pre>$handle->image_max_height = 100;</pre></li>
     *  <li><b>image_max_pixels</b> if set to a number of pixels, the upload will be invalid if the image number of
     *  pixels is greater (default: null)<br>
     *  <pre>$handle->image_max_pixels = 50000;</pre></li>
     *  <li><b>image_max_ratio</b> if set to a aspect ratio (width/height), the upload will be invalid if the image
     *  apect ratio is greater (default: null)<br>
     *  <pre>$handle->image_max_ratio = 1.5;</pre></li>
     *  <li><b>image_min_width</b> if set to a dimension in pixels, the upload will be invalid if the image width is
     *  lower (default: null)<br>
     *  <pre>$handle->image_min_width = 100;</pre></li>
     *  <li><b>image_min_height</b> if set to a dimension in pixels, the upload will be invalid if the image height is
     *  lower (default: null)<br>
     *  <pre>$handle->image_min_height = 500;</pre></li>
     *  <li><b>image_min_pixels</b> if set to a number of pixels, the upload will be invalid if the image number of
     *  pixels is lower (default: null)<br>
     *  <pre>$handle->image_min_pixels = 20000;</pre></li>
     *  <li><b>image_min_ratio</b> if set to a aspect ratio (width/height), the upload will be invalid if the image
     ...
     * <ul>
     *  <li><b>image_ratio</b> if true, resize image conserving the original sizes ratio, using {@link image_x} AND
     *  {@link image_y} as max sizes if true (default: false)<br>
     *  <pre>$handle->image_ratio = true;</pre></li>
     *  <li><b>image_ratio_crop</b> if true, resize image conserving the original sizes ratio, using {@link image_x}
     *  AND {@link image_y} as max sizes, and cropping excedent to fill the space. setting can also be a string, with
     *  one or more from 'TBLR', indicating which side of the image will be kept while cropping (default: false)<br>
     *  <pre>$handle->image_ratio_crop = true;</pre></li>
     *  <li><b>image_ratio_fill</b> if true, resize image conserving the original sizes ratio, using {@link image_x}
     *  AND {@link image_y} as max sizes, fitting the image in the space and coloring the remaining space. setting can
     *  also be a string, with one or more from 'TBLR', indicating which side of the space the image will be in
     *  (default: false)<br>
     *  <pre>$handle->image_ratio_fill = true;</pre></li>
     *  <li><b>image_ratio_no_zoom_in</b> same as {@link image_ratio}, but won't resize if the source image is smaller
     *  than {@link image_x} x {@link image_y} (default: false)<br>
     *  <pre>$handle->image_ratio_no_zoom_in = true;</pre></li>
     *  <li><b>image_ratio_no_zoom_out</b> same as {@link image_ratio}, but won't resize if the source image is bigger
     *  than {@link image_x} x {@link image_y} (default: false)<br>
     *  <pre>$handle->image_ratio_no_zoom_out = true;</pre></li>
     *  <li><b>image_ratio_x</b> if true, resize image, calculating {@link image_x} from {@link image_y} and conserving
     *  the original sizes ratio (default: false)<br>
     *  <pre>$handle->image_ratio_x = true;</pre></li>
     *  <li><b>image_ratio_y</b> if true, resize image, calculating {@link image_y} from {@link image_x} and conserving
     *  the original sizes ratio (default: false)<br>
     *  <pre>$handle->image_ratio_y = true;</pre></li>
     *  <li><b>image_ratio_pixels</b> if set to a long integer, resize image, calculating {@link image_y} and {@link
     *  image_x} to match a the number of pixels (default: false)<br>
     ...
     *  <li><b>image_tint_color</b> if set, will tint the image with a color, value as hexadecimal #FFFFFF (default:
     *  null)<br>
     *  <pre>$handle->image_tint_color = '#FF0000';</pre></li>
     *  <li><b>image_overlay_color</b> if set, will add a colored overlay, value as hexadecimal #FFFFFF (default:
     *  null)<br>
     *  <pre>$handle->image_overlay_color = '#FF0000';</pre></li>
     *  <li><b>image_overlay_percent</b> used when {@link image_overlay_color} is set, determines the opacity (default:
     *  50)<br>
     ...
     * </ul>
     * <ul>
     *  <li><b>image_text</b> creates a text label on the image, value is a string, with eventual replacement tokens
     *  (default: null)<br>
     ...
     *  <li><b>image_text_background_percent</b> text label background opacity, integer between 0 and 100 (default:
     *  100)<br>
     ...
     *  <li><b>image_text_x</b> absolute text label position, in pixels from the left border. can be negative (default:
     *  null)<br>
     *  <pre>$handle->image_text_x = 5;</pre></li>
     *  <li><b>image_text_y</b> absolute text label position, in pixels from the top border. can be negative (default:
     *  null)<br>
     *  <pre>$handle->image_text_y = 5;</pre></li>
     *  <li><b>image_text_position</b> text label position withing the image, a combination of one or two from 'TBLR':
     *  top, bottom, left, right (default: null)<br>
     *  <pre>$handle->image_text_position = 'LR';</pre></li>
     *  <li><b>image_text_padding</b> text label padding, in pixels. can be overridden by {@link image_text_padding_x}
     *  and {@link image_text_padding_y} (default: 0)<br>
     ...
     *  <li><b>image_text_alignment</b> text alignment when text has multiple lines, either 'L', 'C' or 'R' (default:
     *  'C')<br>
     ...
     *  <li><b>image_crop</b> crops image. accepts 4, 2 or 1 values as 'T R B L' or 'TB LR' or 'TBLR'. dimension can be
     *  20, or 20px or 20% (default: null)<br>
     ...
     *  <li><b>image_border</b> adds a unicolor border to the image. accepts 4, 2 or 1 values as 'T R B L' or 'TB LR'
     *  or 'TBLR'. dimension can be 20, or 20px or 20% (default: null)<br>
     ...
     *  <li><b>image_frame_colors</b> list of hex colors, in an array or a space separated string (default: '#FFFFFF
     *  #999999 #666666 #000000')<br>
     *  <pre>$handle->image_frame_colors = array('#999999',  '#FF0000', '#666666', '#333333', '#000000');</pre></li>
     * </ul>
     * <ul>
     *  <li><b>image_watermark</b> adds a watermark on the image, value is a local filename. accepted files are GIF,
     *  JPG, BMP, PNG and PNG alpha (default: null)<br>
     *  <pre>$handle->image_watermark = 'watermark.png';</pre></li>
     *  <li><b>image_watermark_x</b> absolute watermark position, in pixels from the left border. can be negative
     *  (default: null)<br>
     *  <pre>$handle->image_watermark_x = 5;</pre></li>
     *  <li><b>image_watermark_y</b> absolute watermark position, in pixels from the top border. can be negative
     *  (default: null)<br>
     *  <pre>$handle->image_watermark_y = 5;</pre></li>
     *  <li><b>image_watermark_position</b> watermark position withing the image, a combination of one or two from
     *  'TBLR': top, bottom, left, right (default: null)<br>
     *  <pre>$handle->image_watermark_position = 'LR';</pre></li>
     * </ul>
     * <ul>
     *  <li><b>image_reflection_height</b> if set, a reflection will be added. Format is either in pixels or
     *  percentage, such as 40, '40', '40px' or '40%' (default: null)<br>
     *  <pre>$handle->image_reflection_height = '25%';</pre></li>
     *  <li><b>image_reflection_space</b> space in pixels between the source image and the reflection, can be negative
     *  (default: null)<br>
     *  <pre>$handle->image_reflection_space = 3;</pre></li>
     *  <li><b>image_reflection_color</b> reflection background color, in hexadecimal. Now deprecated in favor of
     *  {@link image_default_color} (default: #FFFFFF)<br>
     *  <pre>$handle->image_default_color = '#000000';</pre></li>
     *  <li><b>image_reflection_opacity</b> opacity level at which the reflection starts, integer between 0 and 100
     *  (default: 60)<br>
     ...
     *   - the class now provides some information about the image, before calling {@link process}(). Available are
     *   {@link image_src_x}, {@link image_src_y} and the newly introduced {@link image_src_bits}, {@link
     *   image_src_pixels} and {@link image_src_type}. Note that this will not work if <i>open_basedir</i> restrictions
     *   are in place<br>
     ...
     *   images<br>
     *   - added {@link image_default_color} to define a fallback color for non alpha-transparent output formats, such
     *   as JPEG or BMP<br>
     ...
     *   - transparent PNGs are now processed in true color, and fully preserving the alpha channel when doing
     *   merges<br>
     ...
     *   - transparent true color images can be saved as JPG/BMP with the semi transparent areas being merged with
     *   {@link image_default_color}<br>
     *   - fixed conversion of images to true color<br>
     *   - the class can now output the uploaded files content as the return value of process() if the function is
     *   called with an empty or null argumenti, or no argument</li>
     ...
     *   - added {@link image_ratio_fill} in order to fit an image within some dimensions and color the remaining
     *   space. Very similar to {@link image_ratio_crop}<br>
     ...
     *   - fixed a bug when processing more than once the same uploaded file. If there is an open_basedir restriction,
     *   the class now creates a temporary file for the first call to process(). This file will be used for subsequent
     ...
     *   - modified {@link image_ratio_crop} so it can accept one or more from string 'TBLR', determining which side of
     *   the image is kept while cropping<br>
     ...
     *   - added {@link image_reflection_height} to create a reflection of the source image, which height is in pixels
     *   or percentage<br>
     *   - added {@link image_reflection_space} to set the space in pixels between the source image and the
     *   reflection<br>
     ...
     *   - added {@link image_bevel}, {@link image_bevel_color1} and {@link image_bevel_color2} to add a bevel
     *   border<br>
     ...
     *   - added {@link image_brightness}, {@link image_contrast}, {@link image_tint_color}, {@link
     *   image_overlay_color} and {@link image_overlay_percent} to do color manipulation on the images.<br>
    ...
    class upload
    {
        ...
        /**
         * Set this variable to a number of pixels so that {@link image_x} and {@link image_y} are the best match
         * possible
         *
         ...
         * if you want to output it as a transparent GIFs for instance, you can set a blending color for transparent
         * areas If you output in JPEG or BMP, this color will be used to fill in the previously transparent areas
         *
         ...
         * Value can also be a string, which represents the path to a GDF font. The font will be loaded into GD, and
         * used as a built-in font.
         *
         * Default value is 5
         *
         * @access public
         ...
         *
         * Value is in pixels, representing the distance between the text and the left and right label background
         * borders
         *
         * Default value is null
         *
         ...
         *
         * Value is in pixels, representing the distance between the text and the top and bottom label background
         * borders
         *
         * Default value is null
         *
         ...
         *
         * Value is a local image filename, relative or absolute. GIF, JPG, BMP and PNG are supported, as well as PNG
         * alpha.
         *
         ...
         *
         * Default is a selection of safe mime-types, but you might want to change it
         * To only check for forbidden MIME types, and allow everything else, set {@link allowed} to array('* / *')
         * without the spaces
         *
         * Simple wildcards are allowed, such as image/* or application/*
         *
         ...
         * When you {@link process} the file, you actually copy the resulting file to the given location, it doesn't
         * alter the original file. Once you have processed the file as many times as you wanted, you can delete the
         * uploaded file. If there is open_basedir restrictions, the uploaded file is in fact a temporary file
         *
